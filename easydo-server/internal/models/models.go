...
func managedSchemaColumnSyncs() []columnSync {
	return []columnSync{
		...
		{model: &AIModelCatalog{}, field: "ParameterSize"},
		{model: &AIProvider{}, field: "MetadataJSON"},
		{model: &AIModelBinding{}, field: "ProviderModelKey"},
		{model: &AIModelBinding{}, field: "MetadataJSON"},
		{model: &AIAgent{}, field: "RuntimeProfileID"},
		{model: &AIAgent{}, field: "SystemPrompt"},
		{model: &AIAgent{}, field: "ToolPolicyJSON"},
		{model: &AIAgent{}, field: "ToolsJSON"},
		{model: &AIAgent{}, field: "SkillsJSON"},
		{model: &AIAgent{}, field: "MemoryJSON"},
		{model: &AIAgent{}, field: "MCPServersJSON"},
		{model: &AIAgent{}, field: "SubAgentsJSON"},
		{model: &AIAgent{}, field: "MetadataJSON"},
		{model: &AIRuntimeProfile{}, field: "BindingPriorityJSON"},
		{model: &AIScene{}, field: "SceneType"},
		{model: &AIScene{}, field: "Code"},
		{model: &AIScene{}, field: "MainAgentID"},
		{model: &AIScene{}, field: "ContextProvider"},
		{model: &AIScene{}, field: "Enabled"},
		{model: &AIScene{}, field: "DisplayNameOverride"},
		{model: &AIScene{}, field: "IntroMessageOverride"},
		{model: &AIScene{}, field: "MetadataJSON"},
		{model: &AIScene{}, field: "CreatedBy"},
		{model: &AISession{}, field: "SceneID"},
		{model: &AISession{}, field: "ParentSessionID"},
		{model: &AISession{}, field: "RootSessionID"},
		{model: &AISession{}, field: "RuntimeProfileID"},
		{model: &AISession{}, field: "BindingID"},
		{model: &AISession{}, field: "ContextSnapshotJSON"},
		{model: &AISession{}, field: "MemorySnapshotJSON"},
		{model: &AISession{}, field: "MetadataJSON"},
		{model: &AISessionTurn{}, field: "SessionID"},
		{model: &AISessionTurn{}, field: "TurnType"},
		{model: &AISessionTurn{}, field: "Role"},
		{model: &AISessionTurn{}, field: "Status"},
		{model: &AISessionTurn{}, field: "OutputJSON"},
		{model: &AISessionTurn{}, field: "ErrorMsg"},
		{model: &AISessionTurn{}, field: "MetadataJSON"},
		{model: &AISessionTurn{}, field: "StartedAt"},
		{model: &AISessionTurn{}, field: "CompletedAt"},
		...
		{model: &TemplateParameter{}, field: "ExtraTip"},
	}
}
