...
// AgentLogChunk stores pre-segment durability rows so log reconstruction can
// survive owner restarts before object-storage compaction finishes.
type AgentLogChunk struct {
	...
	Timestamp      int64  `gorm:"not null" json:"timestamp"`
	UniqueKey      string `gorm:"size:128;uniqueIndex" json:"unique_key"`
}
