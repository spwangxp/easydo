...
func Init() {
	...
	Config.SetDefault("ai_runtime.base_url", "")
	Config.SetDefault("ai_runtime.internal_token", "")
	Config.SetDefault("ai_runtime.timeout", 180*time.Second)
	...
	Config.SetDefault("logging.segment_max_age_seconds", 60)
	...
	Config.SetDefault("notification.smtp.tls_mode", "auto")
	...
	Config.BindEnv("ai_runtime.base_url", "AI_RUNTIME_BASE_URL")
	Config.BindEnv("ai_runtime.internal_token", "AI_RUNTIME_INTERNAL_TOKEN")
	Config.BindEnv("ai_runtime.timeout", "AI_RUNTIME_TIMEOUT")
	...
	Config.BindEnv("logging.segment_max_age_seconds", "LOG_SEGMENT_MAX_AGE_SECONDS")
	...
	Config.BindEnv("notification.smtp.tls_mode", "NOTIFICATION_SMTP_TLS_MODE")
