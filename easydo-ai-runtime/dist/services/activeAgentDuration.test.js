...
import { AGENT_ACTIVE_DURATION_ALGORITHM, attachActiveDurationTimings, computeActiveAgentDuration } from './activeAgentDuration.js';
...
describe('attachActiveDurationTimings', () => {
    it('merges active duration fields without dropping total_ms', () => {
        const timings = attachActiveDurationTimings({ total_ms: 9000, first_answer_ms: 100 }, [
            { type: 'session.step.started', timestamp: '2026-07-06T00:00:00.000Z' },
